...
http_archive(
    ...
    strip_prefix = "opencv_4.x_wasm",
    type = "zip",
    sha256 = "1068f0a6308d6bf61e4832a158c6d12480881a4f8c07f50f86dfffef77aa5aa3",
    url = "https://drive.google.com/u/0/uc?id=104uIUGItgyV58BbH2MN7z5yNXRr0_ik-&export=download",
)
...
http_archive(
    name = "emsdk",
    sha256 = "2880831fe7cdecf7f2666bde88a939b240cc2eddc03145c634a4acca08b0c9a5",
    strip_prefix = "emsdk-2.0.16//bazel",
    url = "https://github.com/emscripten-core/emsdk/archive/refs/tags/2.0.16.tar.gz",
)
...
emsdk_emscripten_deps(emscripten_version = "2.0.16")

# Use for newer Emscripten versions:
#load("@emsdk//:toolchains.bzl", "register_emscripten_toolchains")
#register_emscripten_toolchains()
#endregion -------------------------------------------------------------------------------------------------------------
android_sdk_repository(name = "androidsdk", path = "/home/greg/Android/Sdk")
android_ndk_repository(name = "androidndk", api_level=21, path = "/home/greg/Android/Sdk/ndk-bundle/android-ndk-r21")
